...
**Simple name:** AfterPages

Brand product-page gallery (demo checkout).

This is a Grok App Builder project. The sandbox npm name was `app-builder-workspace`. On GitHub it is **S.AfterPages** (private).
...
```bash
cd "/Users/akshitpareta/Documents/S-projects/S.AfterPages"
npm install
npm run dev
```
